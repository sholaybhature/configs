...
let &t_EI = "\<esc>[4 q" " I beam cursor for normal mode
let &t_SR = "\<esc>[3 q" " I beam cursor for replace mode
...
hi ErrorMsg guifg=#c0c0c0 ctermfg=203 guibg=NONE ctermbg=195 gui=reverse cterm=reverse
...
" hi Normal guifg=#c0c0c0 ctermfg=255  
